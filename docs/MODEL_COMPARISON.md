...
## Qwen3.6-35B-A3B vs Gemma-4-26B-A4B on DGX Spark
...
2. **Speed:** Qwen3.6 achieves ~50 tok/s vs Gemma-4-26B-A4B's ~45 tok/s
...
3. **Quantization:**
   ...
   - Gemma-4-26B-A4B: NVFP4 MoE (FlashInfer Cutlass kernels)
